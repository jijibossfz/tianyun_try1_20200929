...
from .models import VerifyCode, Advice
...
class UserViewset(mixins.CreateModelMixin, mixins.UpdateModelMixin, mixins.ListModelMixin, mixins.RetrieveModelMixin,
...
class AdviceViewSet(DynamicModelViewSet):
    """
